...
def AtomLoader(sampler=None, idx=None, numb=1, classic=False, new_parameter=None, classic_parameter=None,
...
def AtomLoader1(sampler=None, idx=None, numb=1, classic=False, new_parameter=None, classic_parameter=None,
    ...
    for i, x in enumerate(idx):
        ...
        des = np.array([np.sin(descriptor[:, :, 0]) * np.cos(descriptor[:, :, 1]),
                        np.sin(descriptor[:, :, 0]) * np.sin(descriptor[:, :, 1]), np.cos(descriptor[:, :, 0])])
